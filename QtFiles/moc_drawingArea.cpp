/****************************************************************************
** Meta object code from reading C++ file 'drawingArea.hpp'
**
...
#include "../gui/drawingArea.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'drawingArea.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_drawingArea_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 26, 0)
    ...
    "drawingArea\0drawSomething\0\0"
};
...
const QMetaObject drawingArea::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_drawingArea.data,
      qt_meta_data_drawingArea,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_drawingArea.stringdata))
